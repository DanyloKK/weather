        ...
        <div className={styles.additional__data}>
            {selectorWeather.map((item, index) => (
                <ul className={styles.additional__data_list} key={item.id}>
                    <li className={styles.additional__data_item}>{item.main.feels_like}<p>Feels like</p></li>
                    <li>
                        <img src={feels} alt="feels_like"/>
                    </li>
                    <li className={styles.additional__data_item}>{item.main.humidity}% <p>Humidity</p></li>
                    <li>
                        <img src={humidity} alt="humidity"/>
                    </li>
                    <li className={styles.additional__data_item}>{item.wind.speed} m/s<p>Wind</p></li>
                    <li>
